...
export default function Page() {
  ...
  const handleLogin = async (formData: FormData) => {
    // if (formData.username === 'llano' && formData.password === 'llano123')
    //   redirect('/dashboard')
    "use server";
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="aelative flex flex-1 flex-shrink-0">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form action={handleLogin} className="space-y-4 md:space-y-6">
                <div>
                  ...
                  <input type="text" name="username" id="username" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="xxxx" required={true} />
                </div>
                <div>
